function new_game() {
	with (Game.UI.section) {
		...
		function step2() {
			...
			new_game_step2.querySelectorAll(".btn-class").forEach(function(e) {
				e.onclick = function() {
					...
					this.className = "btn btn-class btn-selected";
		...
		function forceClose() {
			...
			hide(new_game_step2);
			new_game_step2.querySelectorAll(".btn-class").forEach(function(e) {e.style.backgroundImage = "url(assets/ui/btn/btn-normal.png)"})
		}
